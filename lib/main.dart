...
class _State extends State<CarSpeed> {
  //state class that we make an object from it
 ...
 await  Isolate.spawn(time30To10(currentspeed),currentspeed);
   await  Isolate.spawn(time10To30(currentspeed),currentspeed);
  
  }

  @override
  Widget build(BuildContext context) {
    //context is the data changes
    ...
    return Scaffold(
      ...
      body:
        ...
        Center(
          ...
          Text("Current Speed", style: Theme.of(context).textTheme.bodyText1),
          SevenSegmentDisplay(
              value: '$currentspeed',
              size: 8,
              backgroundColor: Colors.white,
              segmentStyle: HexSegmentStyle(
                  enabledColor: Colors.green, disabledColor: Colors.white)),
          Text("Kmh", style: Theme.of(context).textTheme.bodyText1)
        ])),
        Column(children: <Widget>[
          Text("From 10 to 30 ", style: Theme.of(context).textTheme.bodyText1),
          SevenSegmentDisplay(
            value: "$time10_30",
            size: 8,
            backgroundColor: Colors.white,
        ...
        Column(children: <Widget>[
          Text("From 30 to 10 ", style: Theme.of(context).textTheme.bodyText1),
          SevenSegmentDisplay(
              value: "$time30_10",
              size: 8,
              backgroundColor: Colors.white,
  ...
  void getSpeed() {
   ...
   time10To30(speed) async{
     print("isolate 1 called");
   ...
   time30To10(speed) async {
     print("isolate 2 called");
